...
declare class BaseItem implements PositionService {
     ...
     *
     * All properties except those made with `Scene.setProperty` are copied.
     */
    copy(): BaseItem;
    /**
...
declare namespace Settings {
    /**
     *@deprecated Use `Settings.setFeature` instead.
     *
     *@param permissionName name of the feature.
     */
     ...
     * * `FS_SESSION_PANEL` - Toggle item and scene hierarchy side-bar
     * * `FS_SPACE_CREATION` - Toggle creation of new scenes in side-bar
     *
     *
